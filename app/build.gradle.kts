...
//    implementation(libs.androidx.material.icons.extended) // Add extended icons for SportsEsports
    ...
    implementation(libs.firebase.auth.ktx) // KTX is included in the main module with recent BoM
    implementation(libs.firebase.firestore.ktx) // KTX is included in the main module with recent BoM
