...
// import androidx.compose.foundation.layout.PaddingValues // No longer needed as parameter
...
// import androidx.compose.foundation.layout.wrapContentSize // Not strictly needed, fillMaxSize is used
...
fun InfiniteTicTacToePage(
    ...
    viewModel: InfiniteTicTacToeViewModel = viewModel(factory = LocalViewModelFactory.current)
) {
    LaunchedEffect(Unit) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Infinite Tic Tac Toe") },
                navigationIcon = {
        ...
        Box(
            ...
            Column(
                ...
                Box( // This Box remains for the game board + canvas
                    modifier = Modifier
